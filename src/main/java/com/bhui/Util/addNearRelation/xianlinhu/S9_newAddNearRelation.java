 ...
 * @author JXS
 */
public class S9_newAddNearRelation {

    public static void main(String[] args) {

        String[] textNames = {"jianye2MESOGroup2"};
            ...
            try (DriverCommon driverCommon = new DriverCommon()) {
                ...
                try (Transaction tx = session.beginTransaction()) {
                    ...
                    for (Integer groupId : groupIds) {
                        ...
                        Result result2 = session3.run(" Match (n)-[]->(m)  where m.ID IS NOT NULL and id(n)=" + groupId + " RETURN id(m) as id ;");//获取组节点下面的所有的ID
