 ...
 * @author JXS
 */
public class S9_1addRoadIdInNextToRelation {
    ...
    public final static String Relationship = ImprotLabel.Relationship;//真实图谱的关系
    ...
    private static Integer getGroupRoadId(Session session, Integer groupID1, Integer groupID2) {
        String cypherQuery =
                "MATCH (b1:"+groupLabel+"), (b2:"+groupLabel+") " +
    ...
    public static void addRoadId(Session session) {
        String cypherQuery = "MATCH p=(s:"+groupLabel+")-[r:NEXT_TO]->(e:"+groupLabel+") RETURN id(s) as s,id(e) as e,id(r) as r";
