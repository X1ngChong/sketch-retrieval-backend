...
public class addGroupBox {
    ...
    public static void main(String[] args) {
       ...
       String Relationship = "Contain";//真实图谱的关系
         String label = labelName+"Group";//真实图谱的关系
    ...
    public static List<Integer> fetchFatherIds(Session session,String label,String Relationship) {
    ...
    public static void setFatherBbox(Session session, List<Integer> fatherIds,String Relationship) {
